...
pIDS=''
linkOps=dict(bw=100)#,delay='0.01ms')
...
def test():
    ...
    #block
    print(net.get('h1').cmd('~/virtual/VirtualTimeKernel/iputils/ping -c 1 10.0.0.2'))

    net.get('h1').cmd('~/virtual/VirtualTimeKernel/iputils/ping -c 100 10.0.0.2 > %sbl.test 2>&1 '% FileOut)
    
    #dont block
    net.get('h1').cmd('~/virtual/VirtualTimeKernel/iputils/ping -c 100 10.0.0.2 > %svt.test 2>&1 & '% FileOut)
